package cn.sftech.www.object
{
	...
	public class PopularityScore extends MovieClip
	{
		...
		private function init():void
		{
			...
			scoreNumSymbol.y = Information.popularityScoreSymbol_y;
		...
		public function set score(value:int):void
		{
			...
			scoreNumSymbol.x = Information.popularityScoreSymbol_x-11*pictureLength;
